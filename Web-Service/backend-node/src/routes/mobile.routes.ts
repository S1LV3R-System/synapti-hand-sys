...
import {
  // Parallel upload endpoints (new)
  uploadKeypoints,
  uploadVideo,
  getSessionStatus,
  keypointsUploadMiddleware,
  videoUploadMiddleware,
  // Legacy unified upload (backward compatibility)
  uploadMobileRecording,
  getMobileUploadStatus,
  listMobileUploads,
  mobileUploadMiddleware,
  // Post-processing
  generateLabeledVideo,
  // Protocol sync
  getProtocols,
 ...
 * }
 */
router.post('/keypoints', keypointsUploadMiddleware, uploadKeypoints);
 ...
 */
router.post('/video', videoUploadMiddleware, uploadVideo);
 ...
 * }
 */
router.post('/upload', mobileUploadMiddleware, uploadMobileRecording);
 ...
 * }
 */
router.get('/status/:sessionId', getMobileUploadStatus);
 ...
 * }
 */
router.get('/uploads', listMobileUploads);
 ...
 * }
 */
router.post('/generate-labeled/:sessionId', generateLabeledVideo);
