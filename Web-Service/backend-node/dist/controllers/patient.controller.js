...
exports.deletePatient = exports.getPatientRecordings = exports.updatePatient = exports.createPatient = exports.getPatientById = exports.getPatientsByProject = exports.getAllPatients = void 0;
 ...
 */
const getPatientsByProject = async (req, res) => {
    try {
...
exports.getPatientsByProject = getPatientsByProject;
/**
...
const createPatient = async (req, res) => {
    try {
        const { projectId } = req.params;
        const { patientId, firstName, middleName, lastName, 
        // Legacy field - if patientName is sent, split it
        patientName, gender, birthDate, dateOfBirth, // Legacy alias
        height, weight, diagnosis } = req.body;
        const userId = req.user.userId;
...
const updatePatient = async (req, res) => {
    try {
        const { id } = req.params;
        const { firstName, middleName, lastName, patientName, // Legacy
        gender, birthDate, dateOfBirth, // Legacy
        height, weight, diagnosis } = req.body;
        const userId = req.user.userId;
 ...
 */
const getPatientRecordings = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.userId;
...
exports.getPatientRecordings = getPatientRecordings;
/**
